...
namespace Edwon.UnityTools
{
    public class StaticCoroutine : MonoBehaviour 
    {
        ...
        public static void DoAfter(float delay, System.Action a)
        {
            Build().StartCoroutine(DoAfterCoroutine(delay, a));
        }

        public static IEnumerator DoAfterCoroutine(float delay, System.Action a)
        {
